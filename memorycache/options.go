...
type options[K comparable, V any] struct {
	...
	insertHook            func(K, V) (K, V)
	getHook               func(K, V) (K, V)
}
...
func WithInsertHook[K comparable, V any](onInsertHook func(K, V) (K, V)) Option[K, V] {
	return optionFunc[K, V](func(opts *options[K, V]) {
		opts.insertHook = onInsertHook
	})
}

func WithGetHook[K comparable, V any](onGetHook func(K, V) (K, V)) Option[K, V] {
	return optionFunc[K, V](func(opts *options[K, V]) {
		opts.getHook = onGetHook
	})
}
