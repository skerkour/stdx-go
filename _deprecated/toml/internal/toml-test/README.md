...
work):
    ...
    $ git clone https://github.com/skerkour/stdx-go/toml-test.git
    $ cd toml-test
    $ go build ./cmd/toml-test

This will build a `./toml-test` binary.

[r]: https://github.com/skerkour/stdx-go/toml-test/releases
...
For example, to run the tests against the Go TOML library:
    ...
    # Install my parser
    $ go install github.com/skerkour/stdx-go/toml/cmd/toml-test-decoder@master
    $ go install github.com/skerkour/stdx-go/toml/cmd/toml-test-encoder@master
...
- [Add tags](https://github.com/skerkour/stdx-go/toml/blob/master/internal/tag/add.go)
- [Remove tags](https://github.com/skerkour/stdx-go/toml/blob/master/internal/tag/rm.go)
...
- When testing encoders, the TOML decoder at
  [github.com/skerkour/stdx-go/toml/toml](https://github.com/skerkour/stdx-go/toml) is assumed to be
