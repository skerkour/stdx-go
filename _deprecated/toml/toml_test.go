...
import (
	...
	"github.com/skerkour/stdx-go/toml"
	"github.com/skerkour/stdx-go/toml/internal/tag"
	tomltest "github.com/skerkour/stdx-go/toml/internal/toml-test"
)
	...
	run := func(t *testing.T, enc bool) {
		r := tomltest.Runner{
			...
			SkipTests: []string{
				...
				// https://github.com/skerkour/stdx-go/toml/issues/320
