...
func (c *Cors) handlePreflight(w http.ResponseWriter, r *http.Request) {
	...
	// see https://github.com/skerkour/stdx-go/cors/issues/10,
	//     https://github.com/skerkour/stdx-go/cors/commit/dbdca4d95feaa7511a46e6f1efb3b3aa505bc43f#commitcomment-12352001
...
func (c *Cors) handleActualRequest(w http.ResponseWriter, r *http.Request) {
	...
	// Always set Vary, see https://github.com/skerkour/stdx-go/cors/issues/10
	headers.Add("Vary", "Origin")
	if origin == "" {
