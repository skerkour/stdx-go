...
var (
	pkg       = flag.String("assert-path", "github.com/skerkour/stdx-go/testify/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/skerkour/stdx-go/testify/_codegen; DO NOT EDIT.
