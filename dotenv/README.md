# dotenv ![CI](https://github.com/skerkour/stdx-go/dotenv/workflows/CI/badge.svg) [![Go Report Card](https://goreportcard.com/badge/github.com/skerkour/stdx-go/dotenv)](https://goreportcard.com/report/github.com/skerkour/stdx-go/dotenv)
...
```shell
go get github.com/skerkour/stdx-go/dotenv
```
...
go >= 1.17
```shell
go install github.com/skerkour/stdx-go/dotenv/cmd/dotenv@latest
```

go < 1.17
```shell
go get github.com/skerkour/stdx-go/dotenv/cmd/dotenv
```
...
import (
    ...
    "github.com/skerkour/stdx-go/dotenv"
)
...
This library has been declared feature complete (see [#182](https://github.com/skerkour/stdx-go/dotenv/issues/182) for background) and will not be accepting issues or pull requests adding new functionality or breaking the library API.
...
Use [annotated tags for all releases](https://github.com/skerkour/stdx-go/dotenv/issues/30). Example `git tag -a v1.2.1`
