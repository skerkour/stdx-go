...
[next examples](https://github.com/skerkour/stdx-go/retrytree/master/examples)
...
* 4.0.0
  - infinity retry is possible by set `Attempts(0)` by PR [#49](https://github.com/skerkour/stdx-go/retrypull/49)
...
* 1.0.2 -> 2.0.0
  ...
  - [more about this breaking change](https://github.com/skerkour/stdx-go/retryissues/7)
