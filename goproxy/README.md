...
[![GoDoc](https://godoc.org/github.com/skerkour/stdx-go/goproxy?status.svg)](https://godoc.org/github.com/skerkour/stdx-go/goproxy)
...
![Status](https://github.com/skerkour/stdx-go/goproxy/workflows/Go/badge.svg)
...
import (
    "github.com/skerkour/stdx-go/goproxy"
    "log"
    "net/http"
)
...
[the eavesdropper example](https://github.com/skerkour/stdx-go/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/skerkour/stdx-go/goproxy/tree/master/examples/goproxy-transparent)
